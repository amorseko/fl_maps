...
import 'package:fl_maps/src/ui/main/bantuan/edit_bantuan.dart';
...
class ListBantuanPage extends StatefulWidget {
  @override
  _ListBantuanPage createState() => _ListBantuanPage();
}

class _ListBantuanPage extends State<ListBantuanPage> {
  bool _isAsync = true;
  ...
  List _bantuanData = List<ListBantuanData>();
  ...
  initData() async{
    ...
    await blocListBantuan.getListBantuanBlocs(params.toMap(), (status, error, message, model){

      GetListBantuanModel dataM = model;
...
class BantuanList extends StatelessWidget {
  final int index;
  final ListBantuanData bantuanData;
                  ...
                  child:Column(
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          Text(
                            "Nama Jenis Bantuan : " + bantuanData.nama_bantuan,
                            style: TextStyle(
                                fontSize: 15,
                            ),
                          ),
                                  ...
                                  Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Align(
                                          child: Container(
                                            child: Text(
                                              "Asal Dana : " + bantuanData.asal_dana,
                                              textAlign: TextAlign.left,
                                              style: TextStyle(
                                                fontSize: 12,
                                              ),
