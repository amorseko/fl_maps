...
class NonKinerjaPage extends StatefulWidget {
  @override
  _NonKinerjaPage createState() => _NonKinerjaPage();
}

class _NonKinerjaPage extends State<NonKinerjaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextWidget(txt: "Kinerja Non Bantuan", color: colorTitle()),
