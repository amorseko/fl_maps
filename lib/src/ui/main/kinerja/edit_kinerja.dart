...
class EditKinerjaPage extends StatefulWidget {
  String id_kinerja;
  @override
  _EditKinerjaPage createState() => _EditKinerjaPage();
  EditKinerjaPage({this.id_kinerja});
}

class _EditKinerjaPage extends State<EditKinerjaPage> {
