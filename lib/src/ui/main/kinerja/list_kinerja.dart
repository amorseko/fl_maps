...
class ListKinerjaPage extends StatefulWidget {
  @override
  _ListKinerjaPage createState() => _ListKinerjaPage();
}

class _ListKinerjaPage extends State<ListKinerjaPage> {
  bool _isAsync = true;
          ...
          floatingActionButton: Container(
            ...
            child: Align(
                ...
                child: FloatingActionButton(
                  ...
                  backgroundColor: primaryColor,
                  onPressed: (){
                    routeToWidget(context, KinerjaPage()).then((value) {
                      setPotrait();
                    });
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        IconButton(
                          ...
                          onPressed:(){
//                            print(index);
                            routeToWidget(context, EditKinerjaPage(id_kinerja: kinerjaData.id_kinerja,)).then((value) {
                              setPotrait();
                            });
