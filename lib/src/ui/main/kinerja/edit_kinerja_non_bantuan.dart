...
class EditKinerjaNonBantuanPage extends StatefulWidget {
  String id_kinerja;
  @override
  _EditKinerjaNonBantuanPage createState() => _EditKinerjaNonBantuanPage();
  EditKinerjaNonBantuanPage({this.id_kinerja});
}

class _EditKinerjaNonBantuanPage extends State<EditKinerjaNonBantuanPage> {
    ...
    await blocListKinerja.getListKinerja(data, (status, error, message, model) {
      ...
      setState(() {
        ...
        Timer(Duration(seconds: 1), () {
          _attempJenisProses(dataM.data[0].id_jenis_bantuan);
          _selectedJenisProses = dataM.data[0].id_jenis_proses;
        });
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextWidget(txt: "Edit Kinerja Bantuan", color: colorTitle()),
